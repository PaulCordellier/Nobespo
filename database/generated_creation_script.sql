...
CREATE TABLE film_rating (
    ...
    CONSTRAINT PK_film_rating PRIMARY KEY (user_id, film_id),
    CONSTRAINT fk_user_film_rating FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE CASCADE
);
...
CREATE TABLE serie_rating (
    ...
    serie_rating integer NOT NULL,
    CONSTRAINT pk_serie_rating PRIMARY KEY (user_id, serie_id),
    CONSTRAINT fk_user_serie_rating FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE CASCADE
);
...
CREATE TABLE watchlist_comment (
    ...
    CONSTRAINT fk_user_watchlist_comment FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE CASCADE,
    CONSTRAINT fk_watchlist_comment FOREIGN KEY (watchlist_id) REFERENCES watchlist (watchlist_id) ON DELETE CASCADE
);

CREATE TABLE watchlist_rating (
    user_id integer NOT NULL,
    watchlist_id integer NOT NULL,
    watchlist_rating integer NOT NULL,
    CONSTRAINT pk_watchlist_rating PRIMARY KEY (user_id, watchlist_id),
    CONSTRAINT fk_user_watchlist_rating FOREIGN KEY (user_id) REFERENCES user_data (user_id) ON DELETE CASCADE,
    CONSTRAINT fk_watchlist_rating FOREIGN KEY (watchlist_id) REFERENCES watchlist (watchlist_id) ON DELETE CASCADE
);
