...
public sealed class TmdbApiService
{
    ...
    public async Task<HttpResponseMessage> SearchMulti(string query, string language = "de")
    {
    ...
    public async Task<HttpResponseMessage> GetTrending(string language = "de")
    {
    ...
    public async Task<HttpResponseMessage> GetMovieDetail(int id, string language = "de")
    {
    ...
    public async Task<HttpResponseMessage> GetSerieDetail(int id, string language = "de")
    {
